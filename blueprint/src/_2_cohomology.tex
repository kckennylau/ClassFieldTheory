...
\begin{definition} \label{def:corestriction}
	Let $\{r_i\}$ be a set of representatives for the cosets $r_i S$.
	...
	\begin{itemize}
		\item
		The map $\cor^0 : H^0(S,M) \to H^n(G,M)$ is defined to be $N_{G/S}$.
		\item
...
In this section we'll show that if $M$ is a finite class formation then
