...
\begin{proof}
	Our choice of $S$ implies $\Cl_l \cong \A_{l,S}^\times / \cO_{l,S}^\times$, and
...
\begin{proof}
	Let $M_1$ be the set of defree $1$ primes of $\cO_{k,S}$ which split in $l$ and let $M_2$ be the
	...
	in particular surjective. Hence the image of $P$ in $H^0(l/k,\Cl_l)$ is zero.
	...
	\]
	The results of the previous section implies
	\[
		\sum_{P \in M_1} N(P)^{-s}
		\le
		\frac{1}{|H^0_{\Tate}(l/k,\Cl_l)|} \log \left(\frac{1}{1-s}\right) + O(1).
	\]
	We showed earlier that the left hand side is asymptotic to
